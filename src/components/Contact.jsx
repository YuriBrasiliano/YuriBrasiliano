...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_bkx2wv7', 'template_e542p7m', {from_name: form.name, to_name: 'Yuri', from_email: form.email, to_email: 'yuribrasiliano37@gmail.com', message:form.message}, 'zzDNcoTeusgmre8Xu')
    .then(() =>{
      setLoading(false);
      ...
      setLoading(false)
      console.log(error);
      alert('Something went wrong! Please send your message to yuribrasiliano37@gmail.com')
    }
    )
  }
